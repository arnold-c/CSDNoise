...
for config in multistart_configs
    ...
    println(styled"  Best parameters (optimized):")
    println(styled"    Threshold percentile: {cyan:$(round(best_row.threshold_percentile, digits=3))}")
    println(styled"    Consecutive thresholds: {cyan:$(best_row.consecutive_thresholds)}")
